...
mathjax: "true"
---
In 2019, Spotify held a Datathon who's task is to predict whether Spotify user will skip last song of their listening session. The data provided by Spotify contains two  distinct datasets:
